...
XXX I realized that I just knocked down the features by one level in the hierarchy - could you propagate that through, so that we have a heading level 4 within a feature and consistently level 3 headings for each feature?
